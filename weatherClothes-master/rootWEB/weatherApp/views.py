...
def clothes_insert(request):
    ...
    path = 'C:/Users/user/PycharmProjects/weatherClothes/rootWEB/weatherApp/static/csv/final_clothes_csv.csv'
...
def user_insert(request):
    ...
    path = 'C:/Users/user/PycharmProjects/weatherClothes/rootWEB/weatherApp/static/csv/user.csv'
    file = open(path, 'r',encoding='UTF8')
    reader2 = csv.reader(file)
